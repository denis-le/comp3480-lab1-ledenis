...
def send_email_with_postfix():
    msg = EmailMessage()
    msg['Subject'] = 'Test Email from Python'
    msg['From'] = 'led11docker@wit.edu'
    msg['To'] = 'led11@wit.edu'
    msg.set_content('This is a test email sent via Postfix running in Docker.')

    with smtplib.SMTP('localhost', 1587) as server:
...
def main():
    while True:
        options = [
            ...
            "1. FastAPI",
            "2. SQL Queries",
            "3. MinIO Shared File System",
            "4. Postfix Email Server",
            "5. Redis Shared Memory"
        ]
        ...
        match service:
            ...
            case "3":
                ...
                source_file = "lab8/minio-test.txt"

                # Destionation bucket and file on MinIO server
                ...
                print(f"{source_file} uploaded successfully as object {destination_file} to bucket {bucket_name}\n")
            case "4":
